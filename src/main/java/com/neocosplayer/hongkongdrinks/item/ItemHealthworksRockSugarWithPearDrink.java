...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureHealthworksRockSugarWithPearDrinkOnFoodRightClicked;
...
public class ItemHealthworksRockSugarWithPearDrink extends ElementsHongkongdrinksMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("hongkongdrinks:healthworksrocksugarwithpeardrink", "inventory"));
	}
	public static class ItemFoodCustom extends ItemFood {
		public ItemFoodCustom() {
			super(4, 0.3f, false);
			setUnlocalizedName("healthworksrocksugarwithpeardrink");
			setRegistryName("healthworksrocksugarwithpeardrink");
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureHealthworksRockSugarWithPearDrinkOnFoodRightClicked.executeProcedure($_dependencies);
			}
			return ar;
		}
