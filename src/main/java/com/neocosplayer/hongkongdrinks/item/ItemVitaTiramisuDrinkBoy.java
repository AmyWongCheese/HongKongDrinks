...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaTiramisuDrinkBoyRightClickedInAir;
...
public class ItemVitaTiramisuDrinkBoy extends ElementsHongkongdrinksMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("hongkongdrinks:vita_tiramisu_drink_boy", "inventory"));
	}
	public static class ItemFoodCustom extends ItemFood {
		public ItemFoodCustom() {
			super(4, 0.3f, false);
			setUnlocalizedName("vita_tiramisu_drink_boy");
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureVitaTiramisuDrinkBoyRightClickedInAir.executeProcedure($_dependencies);
			}
			return ar;
		}
