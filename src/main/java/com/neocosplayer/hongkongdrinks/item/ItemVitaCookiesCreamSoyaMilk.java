...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaCookiesCreamSoyaMilkRightClickedInAir;
...
public class ItemVitaCookiesCreamSoyaMilk extends ElementsHongkongdrinksMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("hongkongdrinks:vita_cookies_cream_soya_milk", "inventory"));
	}
	public static class ItemFoodCustom extends ItemFood {
		public ItemFoodCustom() {
			super(4, 0.3f, false);
			setUnlocalizedName("vita_cookies_cream_soya_milk");
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureVitaCookiesCreamSoyaMilkRightClickedInAir.executeProcedure($_dependencies);
			}
			return ar;
		}
