...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureYGOrangeJuiceOnFoodRightClicked;
...
public class ItemYGOrangeJuice extends ElementsHongkongdrinksMod.ModElement {
	@GameRegistry.ObjectHolder("hongkongdrinks:ygorangejuice")
	public static final Item block = null;
	public ItemYGOrangeJuice(ElementsHongkongdrinksMod instance) {
		super(instance, 37);
	}
