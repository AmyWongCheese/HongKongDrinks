...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureTaoTiHoneyGreenTeaOnFoodRightClicked;
...
public class ItemTaoTiHoneyGreenTea extends ElementsHongkongdrinksMod.ModElement {
	@GameRegistry.ObjectHolder("hongkongdrinks:taotihoneygreentea")
	public static final Item block = null;
	public ItemTaoTiHoneyGreenTea(ElementsHongkongdrinksMod instance) {
		super(instance, 31);
	}
