...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitasoyGOBananaPancakeDrinkRightClickedInAir;
...
public class ItemVitasoyGOBananaPancakeDrink extends ElementsHongkongdrinksMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("hongkongdrinks:vitasoy_go_banana_pancake_drink", "inventory"));
	}
	public static class ItemFoodCustom extends ItemFood {
		public ItemFoodCustom() {
			super(4, 0.3f, false);
			setUnlocalizedName("vitasoy_go_banana_pancake_drink");
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureVitasoyGOBananaPancakeDrinkRightClickedInAir.executeProcedure($_dependencies);
			}
			return ar;
		}
