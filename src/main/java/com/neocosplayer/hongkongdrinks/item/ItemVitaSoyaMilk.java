...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaSoyaMilkOnFoodRightClicked;
...
public class ItemVitaSoyaMilk extends ElementsHongkongdrinksMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("hongkongdrinks:vitasoyamilk", "inventory"));
	}
	public static class ItemFoodCustom extends ItemFood {
		public ItemFoodCustom() {
			super(4, 0.3f, false);
			setUnlocalizedName("vitasoyamilk");
			setRegistryName("vitasoyamilk");
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureVitaSoyaMilkOnFoodRightClicked.executeProcedure($_dependencies);
			}
			return ar;
		}
