...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureDrinkTakenSlot14;
import com.neocosplayer.hongkongdrinks.procedure.ProcedureDrinkTakenSlot12;
import com.neocosplayer.hongkongdrinks.procedure.ProcedureDrinkTakenSlot10;
...
public class GuiVendingMachineGui extends ElementsHongkongdrinksMod.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiVendingMachineGui(ElementsHongkongdrinksMod instance) {
		super(instance, 291);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.y = y;
			this.z = z;
			this.internal = new InventoryBasic("", true, 19);
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void actionPerformed(GuiButton button) {
			HongkongdrinksMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (buttonID == 0) {
			{
				...
				ProcedureInputCoin.executeProcedure($_dependencies);
			}
		}
	}
		...
		if (slotID == 6 && changeType == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureDrinkTakenSlot6.executeProcedure($_dependencies);
			}
		}
		if (slotID == 8 && changeType == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureDrinkTakenSlot8.executeProcedure($_dependencies);
			}
		}
		if (slotID == 10 && changeType == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureDrinkTakenSlot10.executeProcedure($_dependencies);
			}
		}
		if (slotID == 12 && changeType == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureDrinkTakenSlot12.executeProcedure($_dependencies);
			}
		}
		if (slotID == 14 && changeType == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureDrinkTakenSlot14.executeProcedure($_dependencies);
			}
		}
		if (slotID == 16 && changeType == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureDrinkTakenSlot16.executeProcedure($_dependencies);
			}
		}
		if (slotID == 18 && changeType == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureDrinkTakenSlot18.executeProcedure($_dependencies);
			}
		}
	}
}
