...
public class ElementsHongkongdrinksMod implements IFuelHandler, IWorldGenerator {
	...
	public static class GuiHandler implements IGuiHandler {
		...
		public Object getServerGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
			if (id == GuiVendingMachineGui.GUIID)
				return new GuiVendingMachineGui.GuiContainerMod(world, x, y, z, player);
			return null;
		}
		...
		public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
			if (id == GuiVendingMachineGui.GUIID)
				return new GuiVendingMachineGui.GuiWindow(world, x, y, z, player);
			return null;
		}
	}
