...
public class ProcedureYGMangoJuiceEntityEntityIsHurt extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureYGMangoJuiceEntityEntityIsHurt(ElementsHongkongdrinksMod instance) {
		super(instance, 78);
	}
