...
public class ProcedureYGOrangeJuiceEntityEntityIsHurt extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureYGOrangeJuiceEntityEntityIsHurt(ElementsHongkongdrinksMod instance) {
		super(instance, 162);
	}
