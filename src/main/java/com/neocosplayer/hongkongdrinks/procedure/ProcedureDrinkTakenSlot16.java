...
public class ProcedureDrinkTakenSlot16 extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureDrinkTakenSlot16(ElementsHongkongdrinksMod instance) {
		super(instance, 300);
	}
