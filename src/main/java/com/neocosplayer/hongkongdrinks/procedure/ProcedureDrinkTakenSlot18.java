...
public class ProcedureDrinkTakenSlot18 extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureDrinkTakenSlot18(ElementsHongkongdrinksMod instance) {
		super(instance, 301);
	}
