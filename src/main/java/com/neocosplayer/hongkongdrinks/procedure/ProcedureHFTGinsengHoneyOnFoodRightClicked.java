...
import com.neocosplayer.hongkongdrinks.entity.EntityHFTGinsengHoneyEntity;
import com.neocosplayer.hongkongdrinks.ElementsHongkongdrinksMod;

@ElementsHongkongdrinksMod.ModElement.Tag
public class ProcedureHFTGinsengHoneyOnFoodRightClicked extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureHFTGinsengHoneyOnFoodRightClicked(ElementsHongkongdrinksMod instance) {
		super(instance, 174);
	}
