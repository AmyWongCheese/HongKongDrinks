...
public class ProcedureVitaImperataeCaneDrinkEntityEntityIsHurt extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureVitaImperataeCaneDrinkEntityEntityIsHurt(ElementsHongkongdrinksMod instance) {
		super(instance, 154);
	}
