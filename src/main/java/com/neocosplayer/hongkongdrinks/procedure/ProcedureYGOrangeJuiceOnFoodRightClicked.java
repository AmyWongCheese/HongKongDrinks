...
import com.neocosplayer.hongkongdrinks.item.ItemYGOrangeJuice;
import com.neocosplayer.hongkongdrinks.entity.EntityYGOrangeJuiceEntity;
import com.neocosplayer.hongkongdrinks.ElementsHongkongdrinksMod;

@ElementsHongkongdrinksMod.ModElement.Tag
public class ProcedureYGOrangeJuiceOnFoodRightClicked extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureYGOrangeJuiceOnFoodRightClicked(ElementsHongkongdrinksMod instance) {
		super(instance, 152);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((((entity.isSneaking()) && (new ItemStack(ItemYGOrangeJuice.block, (int) (1))
			...
			if (entity instanceof EntityPlayer)
				((EntityPlayer) entity).inventory.clearMatchingItems(new ItemStack(ItemYGOrangeJuice.block, (int) (1)).getItem(), -1, (int) 1, null);
			...
			if (((entity.getHorizontalFacing()) == EnumFacing.NORTH)) {
				if (!world.isRemote) {
					Entity entityToSpawn = new EntityYGOrangeJuiceEntity.EntityCustom(world);
