...
public class ProcedureDrinkTakenSlot12 extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureDrinkTakenSlot12(ElementsHongkongdrinksMod instance) {
		super(instance, 298);
	}
