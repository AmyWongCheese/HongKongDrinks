...
import com.neocosplayer.hongkongdrinks.item.ItemHFTGinsengHoney;
import com.neocosplayer.hongkongdrinks.ElementsHongkongdrinksMod;

@ElementsHongkongdrinksMod.ModElement.Tag
public class ProcedureHFTGinsengHoneyEntityEntityIsHurt extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureHFTGinsengHoneyEntityEntityIsHurt(ElementsHongkongdrinksMod instance) {
		super(instance, 173);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((!((entity instanceof EntityPlayer) ? ((EntityPlayer) entity).capabilities.isCreativeMode : false))) {
			if (!world.isRemote) {
				EntityItem entityToSpawn = new EntityItem(world, x, y, z, new ItemStack(ItemHFTGinsengHoney.block, (int) (1)));
