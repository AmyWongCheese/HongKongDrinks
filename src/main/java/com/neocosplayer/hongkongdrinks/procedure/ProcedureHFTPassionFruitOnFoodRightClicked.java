...
import com.neocosplayer.hongkongdrinks.entity.EntityHFTPassionFruitEntity;
...
public class ProcedureHFTPassionFruitOnFoodRightClicked extends ElementsHongkongdrinksMod.ModElement {
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		Entity entityToSpawn = new EntityHFTPassionFruitEntity.EntityCustom(world);
		...
		if ((((entity.isSneaking()) && (new ItemStack(ItemHFTPassionFruit.block, (int) (1))
				...
				|| ((new ItemStack(ItemHFTPassionFruit.block, (int) (1))
			...
			if (entity instanceof EntityPlayer)
				((EntityPlayer) entity).inventory.clearMatchingItems(new ItemStack(ItemHFTPassionFruit.block, (int) (1)).getItem(), -1, (int) 1,
						null);
