...
public class ProcedureTaoTiWhiteTeaEntityEntityIsHurt extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureTaoTiWhiteTeaEntityEntityIsHurt(ElementsHongkongdrinksMod instance) {
		super(instance, 122);
	}
