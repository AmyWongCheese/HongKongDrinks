...
import com.neocosplayer.hongkongdrinks.entity.EntityTaoTiGrapeJuiceEntity;
import com.neocosplayer.hongkongdrinks.ElementsHongkongdrinksMod;

@ElementsHongkongdrinksMod.ModElement.Tag
public class ProcedureTaoTiGrapeJuiceOnFoodRightClicked extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureTaoTiGrapeJuiceOnFoodRightClicked(ElementsHongkongdrinksMod instance) {
		super(instance, 136);
	}
