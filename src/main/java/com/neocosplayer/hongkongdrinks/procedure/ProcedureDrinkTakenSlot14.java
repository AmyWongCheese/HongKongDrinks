...
public class ProcedureDrinkTakenSlot14 extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureDrinkTakenSlot14(ElementsHongkongdrinksMod instance) {
		super(instance, 299);
	}
