...
public class ProcedureDrinkTakenSlot10 extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureDrinkTakenSlot10(ElementsHongkongdrinksMod instance) {
		super(instance, 297);
	}
