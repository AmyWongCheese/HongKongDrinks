...
import com.neocosplayer.hongkongdrinks.entity.EntityYGSugarcaneJuiceEntity;
...
public class ProcedureYGSugarcaneJuiceOnFoodRightClicked extends ElementsHongkongdrinksMod.ModElement {
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((((entity.isSneaking()) && (new ItemStack(ItemYGSugarcaneJuice.block, (int) (1))
				...
				|| ((new ItemStack(ItemYGSugarcaneJuice.block, (int) (1))
			...
			if (entity instanceof EntityPlayer)
				((EntityPlayer) entity).inventory.clearMatchingItems(new ItemStack(ItemYGSugarcaneJuice.block, (int) (1)).getItem(), -1, (int) 1,
						null);
