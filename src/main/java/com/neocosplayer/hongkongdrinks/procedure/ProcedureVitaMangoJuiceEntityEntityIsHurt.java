...
public class ProcedureVitaMangoJuiceEntityEntityIsHurt extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureVitaMangoJuiceEntityEntityIsHurt(ElementsHongkongdrinksMod instance) {
		super(instance, 147);
	}
