...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaTiramisuDrinkGirlEntityEntityIsHurt;
...
public class EntityVitaTiramisuDrinkGirlEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 115;
	public static final int ENTITYID_RANGED = 116;
	public EntityVitaTiramisuDrinkGirlEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 274);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vita_tiramisu_drink_girl_entity"), ENTITYID).name("vita_tiramisu_drink_girl_entity")
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaTiramisuDrinkGirl.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaTiramisuDrinkGirlEntityEntityIsHurt.executeProcedure($_dependencies);
			}
