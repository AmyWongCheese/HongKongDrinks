...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaLemonTeaEntityEntityIsHurt;
...
public class EntityVitaLemonTeaEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 7;
	public static final int ENTITYID_RANGED = 8;
	public EntityVitaLemonTeaEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 49);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vitalemonteaentity"), ENTITYID).name("vitalemonteaentity").tracker(100, 3, true).build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaLemonTea.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaLemonTeaEntityEntityIsHurt.executeProcedure($_dependencies);
			}
