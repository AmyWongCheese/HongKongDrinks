...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaSweetPotatoSoyaMilkEntityEntityIsHurt;
...
public class EntityVitaSweetPotatoSoyaMilkEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 97;
	public static final int ENTITYID_RANGED = 98;
	public EntityVitaSweetPotatoSoyaMilkEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 245);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vita_sweet_potato_soya_milk_entity"), ENTITYID).name("vita_sweet_potato_soya_milk_entity")
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaSweetPotatoSoyaMilk.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaSweetPotatoSoyaMilkEntityEntityIsHurt.executeProcedure($_dependencies);
			}
