...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureYGOrangeJuiceEntityEntityIsHurt;
...
public class EntityYGOrangeJuiceEntity extends ElementsHongkongdrinksMod.ModElement {
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "ygorangejuiceentity"), ENTITYID).name("ygorangejuiceentity").tracker(100, 3, true)
				.build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemYGOrangeJuice.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureYGOrangeJuiceEntityEntityIsHurt.executeProcedure($_dependencies);
			}
