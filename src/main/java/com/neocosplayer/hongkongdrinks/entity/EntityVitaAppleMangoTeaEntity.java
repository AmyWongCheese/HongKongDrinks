...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaAppleMangoTeaEntityEntityIsHurt;
...
public class EntityVitaAppleMangoTeaEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 99;
	public static final int ENTITYID_RANGED = 100;
	public EntityVitaAppleMangoTeaEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 237);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vita_apple_mango_tea_entity"), ENTITYID).name("vita_apple_mango_tea_entity")
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaAppleMangoTea.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaAppleMangoTeaEntityEntityIsHurt.executeProcedure($_dependencies);
			}
