...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaRedBeanSoyaMilkEntityEntityIsHurt;
...
public class EntityVitaRedBeanSoyaMilkEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 109;
	public static final int ENTITYID_RANGED = 110;
	public EntityVitaRedBeanSoyaMilkEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 271);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vita_red_bean_soya_milk_entity"), ENTITYID).name("vita_red_bean_soya_milk_entity")
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaRedBeanSoyaMilk.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaRedBeanSoyaMilkEntityEntityIsHurt.executeProcedure($_dependencies);
			}
