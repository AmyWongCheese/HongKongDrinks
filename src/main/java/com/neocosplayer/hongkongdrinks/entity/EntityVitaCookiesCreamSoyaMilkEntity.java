...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaCookiesCreamSoyaMilkEntityEntityIsHurt;
...
public class EntityVitaCookiesCreamSoyaMilkEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 103;
	public static final int ENTITYID_RANGED = 104;
	public EntityVitaCookiesCreamSoyaMilkEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 247);
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaCookiesCreamSoyaMilk.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaCookiesCreamSoyaMilkEntityEntityIsHurt.executeProcedure($_dependencies);
			}
