...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaHoneyLimeDrinkEntityEntityIsHurt;
...
public class EntityVitaHoneyLimeDrinkEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 43;
	public static final int ENTITYID_RANGED = 44;
	public EntityVitaHoneyLimeDrinkEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 118);
	}
