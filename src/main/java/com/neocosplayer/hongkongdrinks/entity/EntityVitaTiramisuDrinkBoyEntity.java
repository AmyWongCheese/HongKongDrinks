...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaTiramisuDrinkBoyEntityEntityIsHurt;
...
public class EntityVitaTiramisuDrinkBoyEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 113;
	public static final int ENTITYID_RANGED = 114;
	public EntityVitaTiramisuDrinkBoyEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 280);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vita_tiramisu_drink_boy_entity"), ENTITYID).name("vita_tiramisu_drink_boy_entity")
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaTiramisuDrinkBoy.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaTiramisuDrinkBoyEntityEntityIsHurt.executeProcedure($_dependencies);
			}
