...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitasoyGOBananaPancakeDrinkEntityEntityIsHurt;
...
public class EntityVitasoyGOBananaPancakeDrinkEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 101;
	public static final int ENTITYID_RANGED = 102;
	public EntityVitasoyGOBananaPancakeDrinkEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 253);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vitasoy_go_banana_pancake_drink_entity"), ENTITYID)
				.name("vitasoy_go_banana_pancake_drink_entity").tracker(100, 3, true).build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitasoyGOBananaPancakeDrink.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitasoyGOBananaPancakeDrinkEntityEntityIsHurt.executeProcedure($_dependencies);
			}
