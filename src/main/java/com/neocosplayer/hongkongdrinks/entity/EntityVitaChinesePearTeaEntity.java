...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaChinesePearTeaEntityEntityIsHurt;
...
public class EntityVitaChinesePearTeaEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 107;
	public static final int ENTITYID_RANGED = 108;
	public EntityVitaChinesePearTeaEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 256);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vita_chinese_pear_tea_entity"), ENTITYID).name("vita_chinese_pear_tea_entity")
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaChinesePearTea.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaChinesePearTeaEntityEntityIsHurt.executeProcedure($_dependencies);
			}
