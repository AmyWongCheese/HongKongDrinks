...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureYGAppleJuiceEntityEntityIsHurt;
...
public class EntityYGAppleJuiceEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 19;
	public static final int ENTITYID_RANGED = 20;
	public EntityYGAppleJuiceEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 81);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "ygapplejuiceentity"), ENTITYID).name("ygapplejuiceentity").tracker(100, 3, true).build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemYGAppleJuice.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureYGAppleJuiceEntityEntityIsHurt.executeProcedure($_dependencies);
			}
