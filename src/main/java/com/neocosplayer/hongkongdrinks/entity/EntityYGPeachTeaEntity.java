...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureYGPeachTeaEntityEntityIsHurt;
...
public class EntityYGPeachTeaEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 61;
	public static final int ENTITYID_RANGED = 62;
	public EntityYGPeachTeaEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 165);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "ygpeachteaentity"), ENTITYID).name("ygpeachteaentity").tracker(100, 3, true).build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemYGPeachTea.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureYGPeachTeaEntityEntityIsHurt.executeProcedure($_dependencies);
			}
