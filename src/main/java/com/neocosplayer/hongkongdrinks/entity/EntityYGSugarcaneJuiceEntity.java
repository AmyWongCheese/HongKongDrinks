...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureYGSugarcaneJuiceEntityEntityIsHurt;
...
public class EntityYGSugarcaneJuiceEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 93;
	public static final int ENTITYID_RANGED = 94;
	public EntityYGSugarcaneJuiceEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 234);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "ygsugarcanejuiceentity"), ENTITYID).name("ygsugarcanejuiceentity").tracker(100, 3, true)
				.build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemYGSugarcaneJuice.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureYGSugarcaneJuiceEntityEntityIsHurt.executeProcedure($_dependencies);
			}
