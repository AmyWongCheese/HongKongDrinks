...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaOrangeChocoSoyaMilkEntityEntityIsHurt;
...
public class EntityVitaOrangeChocoSoyaMilkEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 105;
	public static final int ENTITYID_RANGED = 106;
	public EntityVitaOrangeChocoSoyaMilkEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 252);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vita_orange_choco_soya_milk_entity"), ENTITYID).name("vita_orange_choco_soya_milk_entity")
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaOrangeChocoSoyaMilk.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaOrangeChocoSoyaMilkEntityEntityIsHurt.executeProcedure($_dependencies);
			}
