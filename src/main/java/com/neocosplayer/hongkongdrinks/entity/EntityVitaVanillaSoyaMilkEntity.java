...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaVanillaSoyaMilkEntityEntityIsHurt;
...
public class EntityVitaVanillaSoyaMilkEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 85;
	public static final int ENTITYID_RANGED = 86;
	public EntityVitaVanillaSoyaMilkEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 222);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vitavanillasoyamilkentity"), ENTITYID).name("vitavanillasoyamilkentity")
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaVanillaSoyaMilk.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaVanillaSoyaMilkEntityEntityIsHurt.executeProcedure($_dependencies);
			}
