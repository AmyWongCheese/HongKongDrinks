...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaImperataeCaneDrinkEntityEntityIsHurt;
...
public class EntityVitaImperataeCaneDrinkEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 55;
	public static final int ENTITYID_RANGED = 56;
	public EntityVitaImperataeCaneDrinkEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 142);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vitaimperataecanedrinkentity"), ENTITYID).name("vitaimperataecanedrinkentity")
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaImperataeCaneDrink.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaImperataeCaneDrinkEntityEntityIsHurt.executeProcedure($_dependencies);
			}
