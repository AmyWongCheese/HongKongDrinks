...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaIcyGrapefruitEntityEntityIsHurt;
...
public class EntityVitaIcyGrapefruitEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 75;
	public static final int ENTITYID_RANGED = 76;
	public EntityVitaIcyGrapefruitEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 183);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vitaicygrapefruitentity"), ENTITYID).name("vitaicygrapefruitentity").tracker(100, 3, true)
				.build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaIcyGrapefruit.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaIcyGrapefruitEntityEntityIsHurt.executeProcedure($_dependencies);
			}
