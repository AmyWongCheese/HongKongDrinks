...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaStrawberrySoyaMilkEntityEntityIsHurt;
...
public class EntityVitaStrawberrySoyaMilkEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 111;
	public static final int ENTITYID_RANGED = 112;
	public EntityVitaStrawberrySoyaMilkEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 265);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vita_strawberry_soya_milk_entity"), ENTITYID).name("vita_strawberry_soya_milk_entity")
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaStrawberrySoyaMilk.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaStrawberrySoyaMilkEntityEntityIsHurt.executeProcedure($_dependencies);
			}
