...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaMintChocoSoyaMilkEntityIsHurt;
...
public class EntityVitaMintChocoSoyaMilkEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 81;
	public static final int ENTITYID_RANGED = 82;
	public EntityVitaMintChocoSoyaMilkEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 203);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vitamintchocosoyamilkentity"), ENTITYID).name("vitamintchocosoyamilkentity")
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaMintChocoSoyaMilk.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaMintChocoSoyaMilkEntityIsHurt.executeProcedure($_dependencies);
			}
