...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureYGChrysanthemumTeaEntityEntityIsHurt;
...
public class EntityYGChrysanthemumTeaEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 23;
	public static final int ENTITYID_RANGED = 24;
	public EntityYGChrysanthemumTeaEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 78);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "ygchrysanthemumteaentity"), ENTITYID).name("ygchrysanthemumteaentity")
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemYGChrysanthemumTea.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureYGChrysanthemumTeaEntityEntityIsHurt.executeProcedure($_dependencies);
			}
