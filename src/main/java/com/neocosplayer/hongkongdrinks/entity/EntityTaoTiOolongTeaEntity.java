...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureTaoTiOolongTeaEntityEntityIsHurt;
...
public class EntityTaoTiOolongTeaEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 49;
	public static final int ENTITYID_RANGED = 50;
	public EntityTaoTiOolongTeaEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 130);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "taotioolongteaentity"), ENTITYID).name("taotioolongteaentity").tracker(100, 3, true)
				.build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemTaoTiOolongTea.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureTaoTiOolongTeaEntityEntityIsHurt.executeProcedure($_dependencies);
			}
