...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureTaoTiWhiteTeaEntityEntityIsHurt;
...
public class EntityTaoTiWhiteTeaEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 39;
	public static final int ENTITYID_RANGED = 40;
	public EntityTaoTiWhiteTeaEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 110);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "taotiwhiteteaentity"), ENTITYID).name("taotiwhiteteaentity").tracker(100, 3, true)
				.build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemTaoTiWhiteTea.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureTaoTiWhiteTeaEntityEntityIsHurt.executeProcedure($_dependencies);
			}
