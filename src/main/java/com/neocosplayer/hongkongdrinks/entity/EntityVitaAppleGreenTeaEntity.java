...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaAppleGreenTeaEntityEntityIsHurt;
...
public class EntityVitaAppleGreenTeaEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 41;
	public static final int ENTITYID_RANGED = 42;
	public EntityVitaAppleGreenTeaEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 114);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vitaapplegreenteaentity"), ENTITYID).name("vitaapplegreenteaentity").tracker(100, 3, true)
				.build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaAppleGreenTea.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaAppleGreenTeaEntityEntityIsHurt.executeProcedure($_dependencies);
			}
