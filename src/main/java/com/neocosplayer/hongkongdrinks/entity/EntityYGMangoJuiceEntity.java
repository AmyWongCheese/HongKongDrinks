...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureYGMangoJuiceEntityEntityIsHurt;
...
public class EntityYGMangoJuiceEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 17;
	public static final int ENTITYID_RANGED = 18;
	public EntityYGMangoJuiceEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 77);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "ygmangojuiceentity"), ENTITYID).name("ygmangojuiceentity").tracker(100, 3, true).build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemYGMangoJuice.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureYGMangoJuiceEntityEntityIsHurt.executeProcedure($_dependencies);
			}
