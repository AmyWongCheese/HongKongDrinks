...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureVitaMangoJuiceEntityEntityIsHurt;
...
public class EntityVitaMangoJuiceEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 57;
	public static final int ENTITYID_RANGED = 58;
	public EntityVitaMangoJuiceEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 157);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vitamangojuiceentity"), ENTITYID).name("vitamangojuiceentity").tracker(100, 3, true)
				.build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaMangoJuice.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaMangoJuiceEntityEntityIsHurt.executeProcedure($_dependencies);
			}
