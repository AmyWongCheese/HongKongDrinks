...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureHFTPassionFruitEntityEntityIsHurt;
...
public class EntityHFTPassionFruitEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 67;
	public static final int ENTITYID_RANGED = 68;
	public EntityHFTPassionFruitEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 179);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "hftpassionfruitentity"), ENTITYID).name("hftpassionfruitentity").tracker(100, 3, true)
				.build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemHFTPassionFruit.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureHFTPassionFruitEntityEntityIsHurt.executeProcedure($_dependencies);
			}
