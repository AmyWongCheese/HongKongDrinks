...
import com.neocosplayer.hongkongdrinks.procedure.ProcedureTaoTiMetaTeaEntityEntityIsHurt;
...
public class EntityTaoTiMetaTeaEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 35;
	public static final int ENTITYID_RANGED = 36;
	public EntityTaoTiMetaTeaEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 113);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "taotimetateaentity"), ENTITYID).name("taotimetateaentity").tracker(100, 3, true).build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemTaoTiMetaTea.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureTaoTiMetaTeaEntityEntityIsHurt.executeProcedure($_dependencies);
			}
