...
public class ProcedureYGMelonMilkEntityEntityIsHurt extends ElementsHongKongDrinks.ModElement {
	public ProcedureYGMelonMilkEntityEntityIsHurt(ElementsHongKongDrinks instance) {
		super(instance, 63);
	}
