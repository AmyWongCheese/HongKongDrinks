...
public class ProcedureVitaVanillaSoyaMilkOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureVitaVanillaSoyaMilkOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 208);
	}
