...
import net.mcreator.hongkongdrinks.entity.EntityYGMangoJuiceEntity;
import net.mcreator.hongkongdrinks.ElementsHongKongDrinks;

@ElementsHongKongDrinks.ModElement.Tag
public class ProcedureYGMangoJuiceOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureYGMangoJuiceOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 33);
	}
