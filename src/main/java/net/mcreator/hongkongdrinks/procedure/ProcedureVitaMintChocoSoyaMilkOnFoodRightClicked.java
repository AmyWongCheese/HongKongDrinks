...
import net.mcreator.hongkongdrinks.entity.EntityVitaMintChocoSoyaMilkEntity;
import net.mcreator.hongkongdrinks.ElementsHongKongDrinks;

@ElementsHongKongDrinks.ModElement.Tag
public class ProcedureVitaMintChocoSoyaMilkOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureVitaMintChocoSoyaMilkOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 198);
	}
