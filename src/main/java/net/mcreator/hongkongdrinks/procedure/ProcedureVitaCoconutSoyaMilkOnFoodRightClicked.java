...
import net.mcreator.hongkongdrinks.entity.EntityVitaCoconutSoyaMilkEntity;
import net.mcreator.hongkongdrinks.ElementsHongKongDrinks;

@ElementsHongKongDrinks.ModElement.Tag
public class ProcedureVitaCoconutSoyaMilkOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureVitaCoconutSoyaMilkOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 193);
	}
