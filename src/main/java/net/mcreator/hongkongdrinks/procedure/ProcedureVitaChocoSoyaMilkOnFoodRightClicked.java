...
import net.mcreator.hongkongdrinks.entity.EntityVitaChocoSoyaMilkEntity;
import net.mcreator.hongkongdrinks.ElementsHongKongDrinks;

@ElementsHongKongDrinks.ModElement.Tag
public class ProcedureVitaChocoSoyaMilkOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureVitaChocoSoyaMilkOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 189);
	}
