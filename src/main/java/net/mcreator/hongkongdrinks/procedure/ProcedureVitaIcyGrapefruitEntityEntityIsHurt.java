...
public class ProcedureVitaIcyGrapefruitEntityEntityIsHurt extends ElementsHongKongDrinks.ModElement {
	public ProcedureVitaIcyGrapefruitEntityEntityIsHurt(ElementsHongKongDrinks instance) {
		super(instance, 184);
	}
