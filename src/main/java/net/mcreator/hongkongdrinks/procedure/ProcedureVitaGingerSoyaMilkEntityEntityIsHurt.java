...
public class ProcedureVitaGingerSoyaMilkEntityEntityIsHurt extends ElementsHongKongDrinks.ModElement {
	public ProcedureVitaGingerSoyaMilkEntityEntityIsHurt(ElementsHongKongDrinks instance) {
		super(instance, 214);
	}
