...
public class ProcedureVitaAppleGreenTeaOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureVitaAppleGreenTeaOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 91);
	}
