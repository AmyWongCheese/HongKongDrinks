...
public class ProcedureVitaMaltSoyaMilkOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureVitaMaltSoyaMilkOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 29);
	}
