...
import net.mcreator.hongkongdrinks.item.ItemVitaMaltSoyaMilk;
import net.mcreator.hongkongdrinks.entity.EntityVitaMaltSoyaMilkEntity;
import net.mcreator.hongkongdrinks.ElementsHongkongdrinksMod;

@ElementsHongkongdrinksMod.ModElement.Tag
public class ProcedureVitaMaltSoyaMilkOnFoodRightClicked extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureVitaMaltSoyaMilkOnFoodRightClicked(ElementsHongkongdrinksMod instance) {
		super(instance, 65);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((((entity.isSneaking()) && (new ItemStack(ItemVitaMaltSoyaMilk.block, (int) (1))
				.getItem() == ((entity instanceof EntityLivingBase) ? ((EntityLivingBase) entity).getHeldItemMainhand() : ItemStack.EMPTY).getItem()))
				|| ((new ItemStack(ItemVitaMaltSoyaMilk.block, (int) (1))
			...
			if (entity instanceof EntityPlayer)
				((EntityPlayer) entity).inventory.clearMatchingItems(new ItemStack(ItemVitaMaltSoyaMilk.block, (int) (1)).getItem(), -1, (int) 1,
						null);
			...
			if (((entity.getHorizontalFacing()) == EnumFacing.NORTH)) {
				if (!world.isRemote) {
					Entity entityToSpawn = new EntityVitaMaltSoyaMilkEntity.EntityCustom(world);
