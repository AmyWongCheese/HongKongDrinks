...
public class ProcedureYGMandarinTeaOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureYGMandarinTeaOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 62);
	}
