...
import net.mcreator.hongkongdrinks.item.ItemYGMandarinTea;
import net.mcreator.hongkongdrinks.entity.EntityYGMandarinTeaEntity;
import net.mcreator.hongkongdrinks.ElementsHongkongdrinksMod;

@ElementsHongkongdrinksMod.ModElement.Tag
public class ProcedureYGMandarinTeaOnFoodRightClicked extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureYGMandarinTeaOnFoodRightClicked(ElementsHongkongdrinksMod instance) {
		super(instance, 93);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((((entity.isSneaking()) && (new ItemStack(ItemYGMandarinTea.block, (int) (1))
			...
			if (entity instanceof EntityPlayer)
				((EntityPlayer) entity).inventory.clearMatchingItems(new ItemStack(ItemYGMandarinTea.block, (int) (1)).getItem(), -1, (int) 1, null);
			...
			if (((entity.getHorizontalFacing()) == EnumFacing.NORTH)) {
				if (!world.isRemote) {
					Entity entityToSpawn = new EntityYGMandarinTeaEntity.EntityCustom(world);
