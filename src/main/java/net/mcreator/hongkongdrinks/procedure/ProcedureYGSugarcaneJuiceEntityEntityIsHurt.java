...
public class ProcedureYGSugarcaneJuiceEntityEntityIsHurt extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureYGSugarcaneJuiceEntityEntityIsHurt(ElementsHongkongdrinksMod instance) {
		super(instance, 222);
	}
