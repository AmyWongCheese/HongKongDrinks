...
public class ProcedureVitaMangoJuiceOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureVitaMangoJuiceOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 131);
	}
