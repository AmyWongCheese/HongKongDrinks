...
public class ProcedureYGHoneyLycheeTeaEntityEntityIsHurt extends ElementsHongKongDrinks.ModElement {
	public ProcedureYGHoneyLycheeTeaEntityEntityIsHurt(ElementsHongKongDrinks instance) {
		super(instance, 218);
	}
