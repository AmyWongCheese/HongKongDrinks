...
public class ProcedureYGPeachTeaEntityEntityIsHurt extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureYGPeachTeaEntityEntityIsHurt(ElementsHongkongdrinksMod instance) {
		super(instance, 155);
	}
