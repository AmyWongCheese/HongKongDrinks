...
public class ProcedureYGOrangeJuiceOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureYGOrangeJuiceOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 136);
	}
