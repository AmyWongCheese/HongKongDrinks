...
import net.mcreator.hongkongdrinks.entity.EntityHealthworksHawhornAppleDrinkEntity;
import net.mcreator.hongkongdrinks.ElementsHongkongdrinksMod;

@ElementsHongkongdrinksMod.ModElement.Tag
public class ProcedureHealthworksHawhornAppleDrinkOnFoodRightClicked extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureHealthworksHawhornAppleDrinkOnFoodRightClicked(ElementsHongkongdrinksMod instance) {
		super(instance, 160);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((((entity.isSneaking()) && (new ItemStack(ItemHealthworksHawhornAppleDrink.block, (int) (1))
				.getItem() == ((entity instanceof EntityLivingBase) ? ((EntityLivingBase) entity).getHeldItemMainhand() : ItemStack.EMPTY).getItem()))
				|| ((new ItemStack(ItemHealthworksHawhornAppleDrink.block, (int) (1))
			...
			if (((entity.getHorizontalFacing()) == EnumFacing.NORTH)) {
				if (!world.isRemote) {
					Entity entityToSpawn = new EntityHealthworksHawhornAppleDrinkEntity.EntityCustom(world);
