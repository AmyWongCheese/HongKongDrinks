...
public class ProcedureHealthworksHawhornAppleDrinkOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureHealthworksHawhornAppleDrinkOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 160);
	}
