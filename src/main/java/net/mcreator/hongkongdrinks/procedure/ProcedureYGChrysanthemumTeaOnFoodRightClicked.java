...
public class ProcedureYGChrysanthemumTeaOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureYGChrysanthemumTeaOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 46);
	}
