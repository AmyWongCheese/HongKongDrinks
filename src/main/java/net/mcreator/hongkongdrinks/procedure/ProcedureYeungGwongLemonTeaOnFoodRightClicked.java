...
import net.mcreator.hongkongdrinks.item.ItemYeungGwongLemonTea;
import net.mcreator.hongkongdrinks.entity.EntityYGLemonTeaEntity;
import net.mcreator.hongkongdrinks.ElementsHongKongDrinks;

@ElementsHongKongDrinks.ModElement.Tag
public class ProcedureYeungGwongLemonTeaOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureYeungGwongLemonTeaOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 21);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure YeungGwongLemonTeaOnFoodRightClicked!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure YeungGwongLemonTeaOnFoodRightClicked!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure YeungGwongLemonTeaOnFoodRightClicked!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure YeungGwongLemonTeaOnFoodRightClicked!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure YeungGwongLemonTeaOnFoodRightClicked!");
			return;
		}
