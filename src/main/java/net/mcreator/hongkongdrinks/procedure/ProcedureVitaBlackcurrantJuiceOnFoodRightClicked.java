...
import net.mcreator.hongkongdrinks.entity.EntityVitaBlackcurrantJuiceEntity;
import net.mcreator.hongkongdrinks.ElementsHongKongDrinks;

@ElementsHongKongDrinks.ModElement.Tag
public class ProcedureVitaBlackcurrantJuiceOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureVitaBlackcurrantJuiceOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 43);
	}
