...
import net.mcreator.hongkongdrinks.entity.EntityTaoTiMetaGreenTeaEntity;
import net.mcreator.hongkongdrinks.ElementsHongkongdrinksMod;

@ElementsHongkongdrinksMod.ModElement.Tag
public class ProcedureTaoTiMetaGreenTeaOnFoodRightClicked extends ElementsHongkongdrinksMod.ModElement {
	public ProcedureTaoTiMetaGreenTeaOnFoodRightClicked(ElementsHongkongdrinksMod instance) {
		super(instance, 108);
	}
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((((entity.isSneaking()) && (new ItemStack(ItemTaoTiMetaGreenTea.block, (int) (1))
				.getItem() == ((entity instanceof EntityLivingBase) ? ((EntityLivingBase) entity).getHeldItemMainhand() : ItemStack.EMPTY).getItem()))
				|| ((new ItemStack(ItemTaoTiMetaGreenTea.block, (int) (1))
			...
			if (entity instanceof EntityPlayer)
				((EntityPlayer) entity).inventory.clearMatchingItems(new ItemStack(ItemTaoTiMetaGreenTea.block, (int) (1)).getItem(), -1, (int) 1,
						null);
			...
			if (((entity.getHorizontalFacing()) == EnumFacing.NORTH)) {
				if (!world.isRemote) {
					Entity entityToSpawn = new EntityTaoTiMetaGreenTeaEntity.EntityCustom(world);
