...
public class ProcedureTaoTiMetaGreenTeaOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureTaoTiMetaGreenTeaOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 81);
	}
