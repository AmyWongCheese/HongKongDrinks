...
public class ProcedureVitaLemonTeaEntityEntityIsHurt extends ElementsHongKongDrinks.ModElement {
	public ProcedureVitaLemonTeaEntityEntityIsHurt(ElementsHongKongDrinks instance) {
		super(instance, 26);
	}
