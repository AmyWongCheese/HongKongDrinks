...
public class ProcedureHFTPassionFruitEntityEntityIsHurt extends ElementsHongKongDrinks.ModElement {
	public ProcedureHFTPassionFruitEntityEntityIsHurt(ElementsHongKongDrinks instance) {
		super(instance, 165);
	}
