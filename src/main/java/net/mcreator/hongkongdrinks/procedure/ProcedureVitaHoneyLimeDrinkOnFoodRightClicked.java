...
public class ProcedureVitaHoneyLimeDrinkOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureVitaHoneyLimeDrinkOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 96);
	}
