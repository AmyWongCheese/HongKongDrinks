...
import net.mcreator.hongkongdrinks.entity.EntityVitaIcyGrapefruitEntity;
import net.mcreator.hongkongdrinks.ElementsHongKongDrinks;

@ElementsHongKongDrinks.ModElement.Tag
public class ProcedureVitaIcyGrapefruitOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureVitaIcyGrapefruitOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 178);
	}
