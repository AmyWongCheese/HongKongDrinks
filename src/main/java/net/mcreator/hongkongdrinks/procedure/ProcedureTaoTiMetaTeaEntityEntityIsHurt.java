...
public class ProcedureTaoTiMetaTeaEntityEntityIsHurt extends ElementsHongKongDrinks.ModElement {
	public ProcedureTaoTiMetaTeaEntityEntityIsHurt(ElementsHongKongDrinks instance) {
		super(instance, 103);
	}
