...
import net.mcreator.hongkongdrinks.entity.EntityVitaChocoMilkEntity;
import net.mcreator.hongkongdrinks.ElementsHongKongDrinks;

@ElementsHongKongDrinks.ModElement.Tag
public class ProcedureVitaChocolateMilkOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureVitaChocolateMilkOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 25);
	}
