...
public class ProcedureHFTGinsengHoneyEntityEntityIsHurt extends ElementsHongKongDrinks.ModElement {
	public ProcedureHFTGinsengHoneyEntityEntityIsHurt(ElementsHongKongDrinks instance) {
		super(instance, 162);
	}
