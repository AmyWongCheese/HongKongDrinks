...
public class ProcedureTaoTiWhiteTeaOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureTaoTiWhiteTeaOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 86);
	}
