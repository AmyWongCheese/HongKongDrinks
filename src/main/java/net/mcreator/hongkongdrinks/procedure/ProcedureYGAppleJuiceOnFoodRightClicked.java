...
public class ProcedureYGAppleJuiceOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureYGAppleJuiceOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 38);
	}
