...
public class ProcedureTaoTiMetaGreenTeaEntityEntityIsHurt extends ElementsHongKongDrinks.ModElement {
	public ProcedureTaoTiMetaGreenTeaEntityEntityIsHurt(ElementsHongKongDrinks instance) {
		super(instance, 83);
	}
