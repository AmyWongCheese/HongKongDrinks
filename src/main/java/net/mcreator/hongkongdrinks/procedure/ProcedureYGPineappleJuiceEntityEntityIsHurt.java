...
public class ProcedureYGPineappleJuiceEntityEntityIsHurt extends ElementsHongKongDrinks.ModElement {
	public ProcedureYGPineappleJuiceEntityEntityIsHurt(ElementsHongKongDrinks instance) {
		super(instance, 72);
	}
