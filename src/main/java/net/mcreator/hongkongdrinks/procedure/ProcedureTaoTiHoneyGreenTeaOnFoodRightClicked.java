...
import net.mcreator.hongkongdrinks.entity.EntityTaoTiHoneyGreenTeaEntity;
import net.mcreator.hongkongdrinks.ElementsHongKongDrinks;

@ElementsHongKongDrinks.ModElement.Tag
public class ProcedureTaoTiHoneyGreenTeaOnFoodRightClicked extends ElementsHongKongDrinks.ModElement {
	public ProcedureTaoTiHoneyGreenTeaOnFoodRightClicked(ElementsHongKongDrinks instance) {
		super(instance, 101);
	}
