...
import net.mcreator.hongkongdrinks.procedure.ProcedureYGCoconutMilkEntityEntityIsHurt;
import net.mcreator.hongkongdrinks.item.ItemYGCoconutMilk;
...
public class EntityYGCoconutMilkEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 25;
	public static final int ENTITYID_RANGED = 26;
	public EntityYGCoconutMilkEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 82);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "ygcoconutmilkentity"), ENTITYID).name("ygcoconutmilkentity").tracker(100, 3, true)
				.build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemYGCoconutMilk.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureYGCoconutMilkEntityEntityIsHurt.executeProcedure($_dependencies);
			}
