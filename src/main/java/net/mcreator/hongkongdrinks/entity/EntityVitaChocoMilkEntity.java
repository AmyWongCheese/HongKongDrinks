...
import net.mcreator.hongkongdrinks.procedure.ProcedureVitaChocoMilkEntityEntityIsHurt;
import net.mcreator.hongkongdrinks.item.ItemVitaChocolateMilk;
...
public class EntityVitaChocoMilkEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 9;
	public static final int ENTITYID_RANGED = 10;
	public EntityVitaChocoMilkEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 52);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "vitachocomilkentity"), ENTITYID).name("vitachocomilkentity").tracker(100, 3, true)
				.build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemVitaChocolateMilk.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureVitaChocoMilkEntityEntityIsHurt.executeProcedure($_dependencies);
			}
