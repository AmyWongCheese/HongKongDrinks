...
import net.mcreator.hongkongdrinks.procedure.ProcedureYGHoneyLycheeTeaEntityEntityIsHurt;
...
public class EntityYGHoneyLycheeTeaEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 91;
	public static final int ENTITYID_RANGED = 92;
	public EntityYGHoneyLycheeTeaEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 219);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "yghoneylycheeteaentity"), ENTITYID).name("yghoneylycheeteaentity").tracker(100, 3, true)
				.build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemYGHoneyLycheeTea.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureYGHoneyLycheeTeaEntityEntityIsHurt.executeProcedure($_dependencies);
			}
