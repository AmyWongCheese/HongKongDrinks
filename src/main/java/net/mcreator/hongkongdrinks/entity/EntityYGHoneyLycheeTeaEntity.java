...
public class EntityYGHoneyLycheeTeaEntity extends ElementsHongKongDrinks.ModElement {
	public static final int ENTITYID = 91;
	public static final int ENTITYID_RANGED = 92;
	public EntityYGHoneyLycheeTeaEntity(ElementsHongKongDrinks instance) {
		super(instance, 219);
	}
