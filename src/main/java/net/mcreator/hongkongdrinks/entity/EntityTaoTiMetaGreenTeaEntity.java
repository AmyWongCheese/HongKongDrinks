...
import net.mcreator.hongkongdrinks.procedure.ProcedureTaoTiMetaGreenTeaEntityEntityIsHurt;
import net.mcreator.hongkongdrinks.item.ItemTaoTiMetaGreenTea;
...
public class EntityTaoTiMetaGreenTeaEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 37;
	public static final int ENTITYID_RANGED = 38;
	public EntityTaoTiMetaGreenTeaEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 106);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "taotimetagreenteaentity"), ENTITYID).name("taotimetagreenteaentity").tracker(100, 3, true)
				.build());
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modeltaotigreenteabottle1(), 0.05f) {
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemTaoTiMetaGreenTea.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureTaoTiMetaGreenTeaEntityEntityIsHurt.executeProcedure($_dependencies);
			}
