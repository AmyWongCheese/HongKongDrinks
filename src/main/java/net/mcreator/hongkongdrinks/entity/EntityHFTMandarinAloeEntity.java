...
import net.mcreator.hongkongdrinks.procedure.ProcedureHFTMandarinAloeEntityEntityIsHurt;
import net.mcreator.hongkongdrinks.item.ItemHFTMandarinAloe;
...
public class EntityHFTMandarinAloeEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 71;
	public static final int ENTITYID_RANGED = 72;
	public EntityHFTMandarinAloeEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 176);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "hftmandarinaloeentity"), ENTITYID).name("hftmandarinaloeentity").tracker(100, 3, true)
				.build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemHFTMandarinAloe.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureHFTMandarinAloeEntityEntityIsHurt.executeProcedure($_dependencies);
			}
