...
import net.mcreator.hongkongdrinks.procedure.ProcedureHFTSaltedMandarinEntityEntityIsHurt;
import net.mcreator.hongkongdrinks.item.ItemHFTSaltedMandarin;
...
public class EntityHFTSaltedMandarinEntity extends ElementsHongKongDrinks.ModElement {
	public static final int ENTITYID = 73;
	public static final int ENTITYID_RANGED = 74;
	public EntityHFTSaltedMandarinEntity(ElementsHongKongDrinks instance) {
		super(instance, 176);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "hftsaltedmandarinentity"), ENTITYID).name("hftsaltedmandarinentity").tracker(100, 3, true)
				.build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemHFTSaltedMandarin.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureHFTSaltedMandarinEntityEntityIsHurt.executeProcedure($_dependencies);
			}
