...
import net.mcreator.hongkongdrinks.procedure.ProcedureYGLemonTeaEntityEntityIsHurt;
...
public class EntityYGLemonTeaEntity extends ElementsHongkongdrinksMod.ModElement {
	public static final int ENTITYID = 11;
	public static final int ENTITYID_RANGED = 12;
	public EntityYGLemonTeaEntity(ElementsHongkongdrinksMod instance) {
		super(instance, 55);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("hongkongdrinks", "yglemonteaentity"), ENTITYID).name("yglemonteaentity").tracker(100, 3, true).build());
	}
	...
	public static class EntityCustom extends EntityCreature {
		...
		protected Item getDropItem() {
			return new ItemStack(ItemYeungGwongLemonTea.block, (int) (1)).getItem();
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity entity = this;
			{
				...
				ProcedureYGLemonTeaEntityEntityIsHurt.executeProcedure($_dependencies);
			}
